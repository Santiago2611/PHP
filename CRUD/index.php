    ...
    <div class="container">
        <div class="table-wrapper">
			...
			<th>E-mail</th>
                    ...
                    {
                        var respuesta = confirm("¿Estás seguro que deseas actualizar?");
                        if(respuesta == true){
                            return true;
                        }else{
                            return false;
                    ...
                    <a href="delete.php?id=<?php echo $id;?>" class="delete" title="Eliminar" data-toggle="tooltip"><i class="material-icons" onclick="return ConfirmDelete()">&#xE872;</i></a>
                    </td>
                    </tr>	
                    <?php
                    }
